...
\lectureheader{161}{Calculus I}{One-sided limits}{\textit{Thomas' Calculus} 2.4}
\begin{definition}
...
\begin{remark}\,
\begin{itemize}
\item The limit from the right only cares about what is happening to $f(x)$ as $x$ approaches $c$ from the right through $x$-values in $\dom(f)$.
\item The limit from the left only cares about what is happening to $f(x)$ as $x$ approaches $c$ from the left through $x$-values in $\dom(f)$.
\end{itemize}
\end{remark}
