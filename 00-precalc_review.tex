...
\begin{itemize}
\item We need more humans that can understand the implications of abstract models. 
\item We need more humans who can direct the computers, shift out the garbage, and interpret the meaningful.
\end{itemize}
...
\item We've had software that can perform staggeringly complex calculations for decades nows.
\item Now the computers are coming after our ability to ``speak math."
\item Everyday the computers are getting better at stringing together mathematical symbols in syntatically correct combinations -- much more accurately than the average freshman.
\item But the computers still don't know what it \underline{means}.  They are just ``stochastic parrots," and you should want to be more than that.
\end{itemize}
...
\item Despite the fact that we are not training to be human computers, we will still perform calculations in this class\dots
\begin{itemize}
\item to practice mathematical reasoning in (relatively) concrete settings.
\item to develop our ``number sense."
\item to develop our ``model sense."
\end{itemize}
\vfill
