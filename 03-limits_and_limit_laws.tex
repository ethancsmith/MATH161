...
\lectureheader{161}{Calculus I}{Limits and limit laws}{\textit{Thomas' Calculus} 2.2}
...
\begin{example}
Since the functions below agree everywhere except at $x=2$, we can say that
\begin{equation*}
\lim_{x\to 2}f(x) = \lim_{x\to 2}g(x) = \lim_{x\to 2}h(x) = 2.
\end{equation*}
\end{example}
