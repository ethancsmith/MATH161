...
\item Since we don't know $\dee x$ exactly but can usually assume that it is small, it is reasonable to use approximation $\Delta y\approx \dee y$ for the propagated error in $y$.
\begin{center}
\begin{tabular}{c||cc}
